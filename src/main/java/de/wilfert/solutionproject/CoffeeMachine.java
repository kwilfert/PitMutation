...
public class CoffeeMachine {
    ...
    public void setCurrentWater(float newWater) {
        this.currentWater = Math.min(newWater, maxWater);
    }
    ...
    public void setCurrentBeans(int newBeans) {
        this.currentBeans = Math.min(newBeans, maxBeans);
    }
    ...
    public void fillWater() {
        //corrected code: filled 1 Unit too much and maxBeans as maximum
    ...
    public void fillBeans() {
        //corrected code: filled 1 Unit too much
